...
import BL.characters_abstract_fabric.concrete_products.Tank;
import Model.Player;

import java.util.Arrays;
import java.util.List;

public class Fabric_Tanque implements Abstract_Fabric_Army {
    @Override
    public Army createArmy(Player owner) {
        List<String> units = Arrays.asList("dragon", "golem", "guardian", "kamikaze");
